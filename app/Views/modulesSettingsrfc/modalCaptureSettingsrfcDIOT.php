                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <select type="text" name="thirdParty" id="thirdParty" class="form-control <?= session('error.thirdParty') ? 'is-invalid' : '' ?>" value="<?= old('thirdParty') ?>" placeholder="<?= lang('settingsrfc.fields.thirdParty') ?>" autocomplete="off">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                               ...
                               <option value="03" >Prestador de servicios </option> 
                               <option value="06" >Arrendamiento </option> 
                               <option value="85" >Otros </option> 
                            </select>
                            </div>
                        </div>
                    </div>
